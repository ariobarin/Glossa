...
5. Confirm the generated manifest matches every portal-ready/package field above, including verified publisher text, all four listing URLs, three starter prompts, category, capabilities, and branding assets.
